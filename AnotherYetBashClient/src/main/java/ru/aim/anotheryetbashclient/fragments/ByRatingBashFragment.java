...
public class ByRatingBashFragment extends AbstractBashFragment {

    int currentType = ActionsAndIntents.TYPE_NEW;
    ...
    void updateHeader() {
        ...
        actionBarTitle = getResources().getString(R.string.app_name_with_type_and_page, types[currentType],
