...
public class SettingsActivity extends PreferenceActivity implements Preference.OnPreferenceChangeListener {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        timePreference.setSummary(getString(R.string.auto_update_summary, SettingsHelper.getUpdateTime(this)));
        ...
        numberPickerPreference.setSummary(getString(R.string.auto_update_depth_summary, SettingsHelper.getOfflinePages(this)));
    }
