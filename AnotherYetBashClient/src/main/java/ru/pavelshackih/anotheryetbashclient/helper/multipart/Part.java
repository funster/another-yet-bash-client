package ru.pavelshackih.anotheryetbashclient.helper.multipart;
...
public abstract class Part {
     ...
     */
    private static final String LOG = "Part";
    ...
    protected void sendStart(OutputStream out) throws IOException {
        L.d(LOG, "enter sendStart(OutputStream out)");
    ...
    protected void sendDispositionHeader(OutputStream out) throws IOException {
        L.d(LOG, "enter sendDispositionHeader(OutputStream out)");
    ...
    protected void sendContentTypeHeader(OutputStream out) throws IOException {
        L.d(LOG, "enter sendContentTypeHeader(OutputStream out)");
